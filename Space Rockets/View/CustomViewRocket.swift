...
class CustomViewRosket: UIView, UICollectionViewDelegate {
    ...
    var imageRocket: UIImageView = {
       ...
       @objc func viewSettingParamRocket() {
           let settingParamRocket = SettingViewParamRocketController()
               viewController?.present(settingParamRocket, animated: true)
       }
    ...
    lazy var buttonToViewLaunches: UIButton = {
      ...
      @objc func viewListSpaceRocket() {
          ...
          viewController?.navigationController?.pushViewController(listSpaceRocket, animated: true)
       }
